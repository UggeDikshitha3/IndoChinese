...
class RestaurantTable(Base):
    ...
    area = Column(String, default="Main Dining Floor", nullable=False)
    status = Column(String, default=TableStatus.AVAILABLE, nullable=False)
    assigned_server = Column(String, nullable=True)
    cleaning_started_at = Column(String, nullable=True)
    seated_at = Column(String, nullable=True)
    current_party_name = Column(String, nullable=True)
    current_guests = Column(Integer, nullable=True)
    expected_vacate_time = Column(String, nullable=True)
